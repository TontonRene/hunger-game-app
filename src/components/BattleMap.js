...
function drawIsoCharacter(canvas, cv, hm, t, camIx, camIy, zoom, W, H, fm, spriteImgs) {
  ...
  if (bodyImg) {
    ...
    const HAIR_DX  =  spW * 0.003;   // quasi centré
...
export default function BattleMap({ battleState, onChampionTap, dropMode, onDropRelease }) {
  ...
  const lpcBodyMaleBackslash = useImage(require('../../assets/sprites/lpc/body/male_backslash.png'));
  const lpcBodyMaleClimb = useImage(require('../../assets/sprites/lpc/body/male_climb.png'));
  const lpcBodyMaleCombatidle = useImage(require('../../assets/sprites/lpc/body/male_combat_idle.png'));
  const lpcBodyMaleEmote = useImage(require('../../assets/sprites/lpc/body/male_emote.png'));
  const lpcBodyMaleHalfslash = useImage(require('../../assets/sprites/lpc/body/male_halfslash.png'));
  const lpcBodyMaleJump = useImage(require('../../assets/sprites/lpc/body/male_jump.png'));
  const lpcBodyMaleRun = useImage(require('../../assets/sprites/lpc/body/male_run.png'));
  const lpcBodyMaleShoot = useImage(require('../../assets/sprites/lpc/body/male_shoot.png'));
  const lpcBodyMaleSit = useImage(require('../../assets/sprites/lpc/body/male_sit.png'));
  const lpcBodyMaleSpellcast = useImage(require('../../assets/sprites/lpc/body/male_spellcast.png'));
  const lpcBodyMaleThrust = useImage(require('../../assets/sprites/lpc/body/male_thrust.png'));
  const lpcBodyFemaleBackslash = useImage(require('../../assets/sprites/lpc/body/female_backslash.png'));
  const lpcBodyFemaleClimb = useImage(require('../../assets/sprites/lpc/body/female_climb.png'));
  const lpcBodyFemaleCombatidle = useImage(require('../../assets/sprites/lpc/body/female_combat_idle.png'));
  const lpcBodyFemaleEmote = useImage(require('../../assets/sprites/lpc/body/female_emote.png'));
  const lpcBodyFemaleHalfslash = useImage(require('../../assets/sprites/lpc/body/female_halfslash.png'));
  const lpcBodyFemaleJump = useImage(require('../../assets/sprites/lpc/body/female_jump.png'));
  const lpcBodyFemaleRun = useImage(require('../../assets/sprites/lpc/body/female_run.png'));
  const lpcBodyFemaleShoot = useImage(require('../../assets/sprites/lpc/body/female_shoot.png'));
  const lpcBodyFemaleSit = useImage(require('../../assets/sprites/lpc/body/female_sit.png'));
  const lpcBodyFemaleSpellcast = useImage(require('../../assets/sprites/lpc/body/female_spellcast.png'));
  const lpcBodyFemaleThrust = useImage(require('../../assets/sprites/lpc/body/female_thrust.png'));
  const lpcHairBobBackslash = useImage(require('../../assets/sprites/lpc/hair/bob_backslash.png'));
  const lpcHairBobClimb = useImage(require('../../assets/sprites/lpc/hair/bob_climb.png'));
  const lpcHairBobCombatidle = useImage(require('../../assets/sprites/lpc/hair/bob_combat_idle.png'));
  const lpcHairBobEmote = useImage(require('../../assets/sprites/lpc/hair/bob_emote.png'));
  const lpcHairBobHalfslash = useImage(require('../../assets/sprites/lpc/hair/bob_halfslash.png'));
  const lpcHairBobJump = useImage(require('../../assets/sprites/lpc/hair/bob_jump.png'));
  const lpcHairBobRun = useImage(require('../../assets/sprites/lpc/hair/bob_run.png'));
  const lpcHairBobShoot = useImage(require('../../assets/sprites/lpc/hair/bob_shoot.png'));
  const lpcHairBobSit = useImage(require('../../assets/sprites/lpc/hair/bob_sit.png'));
  const lpcHairBobSpellcast = useImage(require('../../assets/sprites/lpc/hair/bob_spellcast.png'));
  const lpcHairBobThrust = useImage(require('../../assets/sprites/lpc/hair/bob_thrust.png'));
  const lpcHairBraidBackslash = useImage(require('../../assets/sprites/lpc/hair/braid_backslash.png'));
  const lpcHairBraidClimb = useImage(require('../../assets/sprites/lpc/hair/braid_climb.png'));
  const lpcHairBraidCombatidle = useImage(require('../../assets/sprites/lpc/hair/braid_combat_idle.png'));
  const lpcHairBraidEmote = useImage(require('../../assets/sprites/lpc/hair/braid_emote.png'));
  const lpcHairBraidHalfslash = useImage(require('../../assets/sprites/lpc/hair/braid_halfslash.png'));
  const lpcHairBraidJump = useImage(require('../../assets/sprites/lpc/hair/braid_jump.png'));
  const lpcHairBraidRun = useImage(require('../../assets/sprites/lpc/hair/braid_run.png'));
  const lpcHairBraidShoot = useImage(require('../../assets/sprites/lpc/hair/braid_shoot.png'));
  const lpcHairBraidSit = useImage(require('../../assets/sprites/lpc/hair/braid_sit.png'));
  const lpcHairBraidSpellcast = useImage(require('../../assets/sprites/lpc/hair/braid_spellcast.png'));
  const lpcHairBraidThrust = useImage(require('../../assets/sprites/lpc/hair/braid_thrust.png'));
  const lpcHairBangsBackslash = useImage(require('../../assets/sprites/lpc/hair/bangs_backslash.png'));
  const lpcHairBangsClimb = useImage(require('../../assets/sprites/lpc/hair/bangs_climb.png'));
  const lpcHairBangsCombatidle = useImage(require('../../assets/sprites/lpc/hair/bangs_combat_idle.png'));
  const lpcHairBangsEmote = useImage(require('../../assets/sprites/lpc/hair/bangs_emote.png'));
  const lpcHairBangsHalfslash = useImage(require('../../assets/sprites/lpc/hair/bangs_halfslash.png'));
  const lpcHairBangsJump = useImage(require('../../assets/sprites/lpc/hair/bangs_jump.png'));
  const lpcHairBangsRun = useImage(require('../../assets/sprites/lpc/hair/bangs_run.png'));
  const lpcHairBangsShoot = useImage(require('../../assets/sprites/lpc/hair/bangs_shoot.png'));
  const lpcHairBangsSit = useImage(require('../../assets/sprites/lpc/hair/bangs_sit.png'));
  const lpcHairBangsSpellcast = useImage(require('../../assets/sprites/lpc/hair/bangs_spellcast.png'));
  const lpcHairBangsThrust = useImage(require('../../assets/sprites/lpc/hair/bangs_thrust.png'));
  const lpcHairAfroBackslash = useImage(require('../../assets/sprites/lpc/hair/afro_backslash.png'));
  const lpcHairAfroClimb = useImage(require('../../assets/sprites/lpc/hair/afro_climb.png'));
  const lpcHairAfroCombatidle = useImage(require('../../assets/sprites/lpc/hair/afro_combat_idle.png'));
  const lpcHairAfroEmote = useImage(require('../../assets/sprites/lpc/hair/afro_emote.png'));
  const lpcHairAfroHalfslash = useImage(require('../../assets/sprites/lpc/hair/afro_halfslash.png'));
  const lpcHairAfroJump = useImage(require('../../assets/sprites/lpc/hair/afro_jump.png'));
  const lpcHairAfroRun = useImage(require('../../assets/sprites/lpc/hair/afro_run.png'));
  const lpcHairAfroShoot = useImage(require('../../assets/sprites/lpc/hair/afro_shoot.png'));
  const lpcHairAfroSit = useImage(require('../../assets/sprites/lpc/hair/afro_sit.png'));
  const lpcHairAfroSpellcast = useImage(require('../../assets/sprites/lpc/hair/afro_spellcast.png'));
  const lpcHairAfroThrust = useImage(require('../../assets/sprites/lpc/hair/afro_thrust.png'));
  const lpcHairBuzzcutBackslash = useImage(require('../../assets/sprites/lpc/hair/buzzcut_backslash.png'));
  const lpcHairBuzzcutClimb = useImage(require('../../assets/sprites/lpc/hair/buzzcut_climb.png'));
  const lpcHairBuzzcutCombatidle = useImage(require('../../assets/sprites/lpc/hair/buzzcut_combat_idle.png'));
  const lpcHairBuzzcutEmote = useImage(require('../../assets/sprites/lpc/hair/buzzcut_emote.png'));
  const lpcHairBuzzcutHalfslash = useImage(require('../../assets/sprites/lpc/hair/buzzcut_halfslash.png'));
  const lpcHairBuzzcutJump = useImage(require('../../assets/sprites/lpc/hair/buzzcut_jump.png'));
  const lpcHairBuzzcutRun = useImage(require('../../assets/sprites/lpc/hair/buzzcut_run.png'));
  const lpcHairBuzzcutShoot = useImage(require('../../assets/sprites/lpc/hair/buzzcut_shoot.png'));
  const lpcHairBuzzcutSit = useImage(require('../../assets/sprites/lpc/hair/buzzcut_sit.png'));
  const lpcHairBuzzcutSpellcast = useImage(require('../../assets/sprites/lpc/hair/buzzcut_spellcast.png'));
  const lpcHairBuzzcutThrust = useImage(require('../../assets/sprites/lpc/hair/buzzcut_thrust.png'));
  const lpcHairCornrowsBackslash = useImage(require('../../assets/sprites/lpc/hair/cornrows_backslash.png'));
  const lpcHairCornrowsClimb = useImage(require('../../assets/sprites/lpc/hair/cornrows_climb.png'));
  const lpcHairCornrowsCombatidle = useImage(require('../../assets/sprites/lpc/hair/cornrows_combat_idle.png'));
  const lpcHairCornrowsEmote = useImage(require('../../assets/sprites/lpc/hair/cornrows_emote.png'));
  const lpcHairCornrowsHalfslash = useImage(require('../../assets/sprites/lpc/hair/cornrows_halfslash.png'));
  const lpcHairCornrowsJump = useImage(require('../../assets/sprites/lpc/hair/cornrows_jump.png'));
  const lpcHairCornrowsRun = useImage(require('../../assets/sprites/lpc/hair/cornrows_run.png'));
  const lpcHairCornrowsShoot = useImage(require('../../assets/sprites/lpc/hair/cornrows_shoot.png'));
  const lpcHairCornrowsSit = useImage(require('../../assets/sprites/lpc/hair/cornrows_sit.png'));
  const lpcHairCornrowsSpellcast = useImage(require('../../assets/sprites/lpc/hair/cornrows_spellcast.png'));
  const lpcHairCornrowsThrust = useImage(require('../../assets/sprites/lpc/hair/cornrows_thrust.png'));
  const lpcHairCurlyBackslash = useImage(require('../../assets/sprites/lpc/hair/curly_backslash.png'));
  const lpcHairCurlyClimb = useImage(require('../../assets/sprites/lpc/hair/curly_climb.png'));
  const lpcHairCurlyCombatidle = useImage(require('../../assets/sprites/lpc/hair/curly_combat_idle.png'));
  const lpcHairCurlyEmote = useImage(require('../../assets/sprites/lpc/hair/curly_emote.png'));
  const lpcHairCurlyHalfslash = useImage(require('../../assets/sprites/lpc/hair/curly_halfslash.png'));
  const lpcHairCurlyJump = useImage(require('../../assets/sprites/lpc/hair/curly_jump.png'));
  const lpcHairCurlyRun = useImage(require('../../assets/sprites/lpc/hair/curly_run.png'));
  const lpcHairCurlyShoot = useImage(require('../../assets/sprites/lpc/hair/curly_shoot.png'));
  const lpcHairCurlySit = useImage(require('../../assets/sprites/lpc/hair/curly_sit.png'));
  const lpcHairCurlySpellcast = useImage(require('../../assets/sprites/lpc/hair/curly_spellcast.png'));
  const lpcHairCurlyThrust = useImage(require('../../assets/sprites/lpc/hair/curly_thrust.png'));
  const lpcHairLongBackslash = useImage(require('../../assets/sprites/lpc/hair/long_backslash.png'));
  const lpcHairLongClimb = useImage(require('../../assets/sprites/lpc/hair/long_climb.png'));
  const lpcHairLongCombatidle = useImage(require('../../assets/sprites/lpc/hair/long_combat_idle.png'));
  const lpcHairLongEmote = useImage(require('../../assets/sprites/lpc/hair/long_emote.png'));
  const lpcHairLongHalfslash = useImage(require('../../assets/sprites/lpc/hair/long_halfslash.png'));
  const lpcHairLongJump = useImage(require('../../assets/sprites/lpc/hair/long_jump.png'));
  const lpcHairLongRun = useImage(require('../../assets/sprites/lpc/hair/long_run.png'));
  const lpcHairLongShoot = useImage(require('../../assets/sprites/lpc/hair/long_shoot.png'));
  const lpcHairLongSit = useImage(require('../../assets/sprites/lpc/hair/long_sit.png'));
  const lpcHairLongSpellcast = useImage(require('../../assets/sprites/lpc/hair/long_spellcast.png'));
  const lpcHairLongThrust = useImage(require('../../assets/sprites/lpc/hair/long_thrust.png'));
  const lpcTorsoTshirtBackslash = useImage(require('../../assets/sprites/lpc/torso/tshirt_backslash.png'));
  const lpcTorsoTshirtClimb = useImage(require('../../assets/sprites/lpc/torso/tshirt_climb.png'));
  const lpcTorsoTshirtCombatidle = useImage(require('../../assets/sprites/lpc/torso/tshirt_combat_idle.png'));
  const lpcTorsoTshirtEmote = useImage(require('../../assets/sprites/lpc/torso/tshirt_emote.png'));
  const lpcTorsoTshirtHalfslash = useImage(require('../../assets/sprites/lpc/torso/tshirt_halfslash.png'));
  const lpcTorsoTshirtJump = useImage(require('../../assets/sprites/lpc/torso/tshirt_jump.png'));
  const lpcTorsoTshirtRun = useImage(require('../../assets/sprites/lpc/torso/tshirt_run.png'));
  const lpcTorsoTshirtShoot = useImage(require('../../assets/sprites/lpc/torso/tshirt_shoot.png'));
  const lpcTorsoTshirtSit = useImage(require('../../assets/sprites/lpc/torso/tshirt_sit.png'));
  const lpcTorsoTshirtSpellcast = useImage(require('../../assets/sprites/lpc/torso/tshirt_spellcast.png'));
  const lpcTorsoTshirtThrust = useImage(require('../../assets/sprites/lpc/torso/tshirt_thrust.png'));
  const lpcTorsoLeatherClimb = useImage(require('../../assets/sprites/lpc/torso/leather_climb.png'));
  const lpcTorsoLeatherEmote = useImage(require('../../assets/sprites/lpc/torso/leather_emote.png'));
  const lpcTorsoLeatherJump = useImage(require('../../assets/sprites/lpc/torso/leather_jump.png'));
  const lpcTorsoLeatherShoot = useImage(require('../../assets/sprites/lpc/torso/leather_shoot.png'));
  const lpcTorsoLeatherSit = useImage(require('../../assets/sprites/lpc/torso/leather_sit.png'));
  const lpcTorsoLeatherSpellcast = useImage(require('../../assets/sprites/lpc/torso/leather_spellcast.png'));
  const lpcTorsoLeatherThrust = useImage(require('../../assets/sprites/lpc/torso/leather_thrust.png'));
  const lpcTorsoPlateBackslash = useImage(require('../../assets/sprites/lpc/torso/plate_backslash.png'));
  const lpcTorsoPlateClimb = useImage(require('../../assets/sprites/lpc/torso/plate_climb.png'));
  const lpcTorsoPlateCombatidle = useImage(require('../../assets/sprites/lpc/torso/plate_combat_idle.png'));
  const lpcTorsoPlateEmote = useImage(require('../../assets/sprites/lpc/torso/plate_emote.png'));
  const lpcTorsoPlateHalfslash = useImage(require('../../assets/sprites/lpc/torso/plate_halfslash.png'));
  const lpcTorsoPlateJump = useImage(require('../../assets/sprites/lpc/torso/plate_jump.png'));
  const lpcTorsoPlateRun = useImage(require('../../assets/sprites/lpc/torso/plate_run.png'));
  const lpcTorsoPlateShoot = useImage(require('../../assets/sprites/lpc/torso/plate_shoot.png'));
  const lpcTorsoPlateSit = useImage(require('../../assets/sprites/lpc/torso/plate_sit.png'));
  const lpcTorsoPlateSpellcast = useImage(require('../../assets/sprites/lpc/torso/plate_spellcast.png'));
  const lpcTorsoPlateThrust = useImage(require('../../assets/sprites/lpc/torso/plate_thrust.png'));
  const lpcLegsPantsBackslash = useImage(require('../../assets/sprites/lpc/legs/pants_backslash.png'));
  const lpcLegsPantsClimb = useImage(require('../../assets/sprites/lpc/legs/pants_climb.png'));
  const lpcLegsPantsCombatidle = useImage(require('../../assets/sprites/lpc/legs/pants_combat_idle.png'));
  const lpcLegsPantsEmote = useImage(require('../../assets/sprites/lpc/legs/pants_emote.png'));
  const lpcLegsPantsHalfslash = useImage(require('../../assets/sprites/lpc/legs/pants_halfslash.png'));
  const lpcLegsPantsJump = useImage(require('../../assets/sprites/lpc/legs/pants_jump.png'));
  const lpcLegsPantsRun = useImage(require('../../assets/sprites/lpc/legs/pants_run.png'));
  const lpcLegsPantsShoot = useImage(require('../../assets/sprites/lpc/legs/pants_shoot.png'));
  const lpcLegsPantsSit = useImage(require('../../assets/sprites/lpc/legs/pants_sit.png'));
  const lpcLegsPantsSpellcast = useImage(require('../../assets/sprites/lpc/legs/pants_spellcast.png'));
  const lpcLegsPantsThrust = useImage(require('../../assets/sprites/lpc/legs/pants_thrust.png'));
  const lpcLegsShortsBackslash = useImage(require('../../assets/sprites/lpc/legs/shorts_backslash.png'));
  const lpcLegsShortsClimb = useImage(require('../../assets/sprites/lpc/legs/shorts_climb.png'));
  const lpcLegsShortsCombatidle = useImage(require('../../assets/sprites/lpc/legs/shorts_combat_idle.png'));
  const lpcLegsShortsEmote = useImage(require('../../assets/sprites/lpc/legs/shorts_emote.png'));
  const lpcLegsShortsHalfslash = useImage(require('../../assets/sprites/lpc/legs/shorts_halfslash.png'));
  const lpcLegsShortsJump = useImage(require('../../assets/sprites/lpc/legs/shorts_jump.png'));
  const lpcLegsShortsRun = useImage(require('../../assets/sprites/lpc/legs/shorts_run.png'));
  const lpcLegsShortsShoot = useImage(require('../../assets/sprites/lpc/legs/shorts_shoot.png'));
  const lpcLegsShortsSit = useImage(require('../../assets/sprites/lpc/legs/shorts_sit.png'));
  const lpcLegsShortsSpellcast = useImage(require('../../assets/sprites/lpc/legs/shorts_spellcast.png'));
  const lpcLegsShortsThrust = useImage(require('../../assets/sprites/lpc/legs/shorts_thrust.png'));
  const lpcFeetBootsBackslash = useImage(require('../../assets/sprites/lpc/feet/boots_backslash.png'));
  const lpcFeetBootsClimb = useImage(require('../../assets/sprites/lpc/feet/boots_climb.png'));
  const lpcFeetBootsCombatidle = useImage(require('../../assets/sprites/lpc/feet/boots_combat_idle.png'));
  const lpcFeetBootsEmote = useImage(require('../../assets/sprites/lpc/feet/boots_emote.png'));
  const lpcFeetBootsHalfslash = useImage(require('../../assets/sprites/lpc/feet/boots_halfslash.png'));
  const lpcFeetBootsJump = useImage(require('../../assets/sprites/lpc/feet/boots_jump.png'));
  const lpcFeetBootsRun = useImage(require('../../assets/sprites/lpc/feet/boots_run.png'));
  const lpcFeetBootsShoot = useImage(require('../../assets/sprites/lpc/feet/boots_shoot.png'));
  const lpcFeetBootsSit = useImage(require('../../assets/sprites/lpc/feet/boots_sit.png'));
  const lpcFeetBootsSpellcast = useImage(require('../../assets/sprites/lpc/feet/boots_spellcast.png'));
  const lpcFeetBootsThrust = useImage(require('../../assets/sprites/lpc/feet/boots_thrust.png'));
  ...
  useEffect(() => {
    ...
    if (lpcBodyMaleBackslash) c['lpc_body_male_backslash'] = lpcBodyMaleBackslash;
    if (lpcBodyMaleClimb) c['lpc_body_male_climb'] = lpcBodyMaleClimb;
    if (lpcBodyMaleCombatidle) c['lpc_body_male_combat_idle'] = lpcBodyMaleCombatidle;
    if (lpcBodyMaleEmote) c['lpc_body_male_emote'] = lpcBodyMaleEmote;
    if (lpcBodyMaleHalfslash) c['lpc_body_male_halfslash'] = lpcBodyMaleHalfslash;
    if (lpcBodyMaleJump) c['lpc_body_male_jump'] = lpcBodyMaleJump;
    if (lpcBodyMaleRun) c['lpc_body_male_run'] = lpcBodyMaleRun;
    if (lpcBodyMaleShoot) c['lpc_body_male_shoot'] = lpcBodyMaleShoot;
    if (lpcBodyMaleSit) c['lpc_body_male_sit'] = lpcBodyMaleSit;
    if (lpcBodyMaleSpellcast) c['lpc_body_male_spellcast'] = lpcBodyMaleSpellcast;
    if (lpcBodyMaleThrust) c['lpc_body_male_thrust'] = lpcBodyMaleThrust;
    if (lpcBodyFemaleBackslash) c['lpc_body_female_backslash'] = lpcBodyFemaleBackslash;
    if (lpcBodyFemaleClimb) c['lpc_body_female_climb'] = lpcBodyFemaleClimb;
    if (lpcBodyFemaleCombatidle) c['lpc_body_female_combat_idle'] = lpcBodyFemaleCombatidle;
    if (lpcBodyFemaleEmote) c['lpc_body_female_emote'] = lpcBodyFemaleEmote;
    if (lpcBodyFemaleHalfslash) c['lpc_body_female_halfslash'] = lpcBodyFemaleHalfslash;
    if (lpcBodyFemaleJump) c['lpc_body_female_jump'] = lpcBodyFemaleJump;
    if (lpcBodyFemaleRun) c['lpc_body_female_run'] = lpcBodyFemaleRun;
    if (lpcBodyFemaleShoot) c['lpc_body_female_shoot'] = lpcBodyFemaleShoot;
    if (lpcBodyFemaleSit) c['lpc_body_female_sit'] = lpcBodyFemaleSit;
    if (lpcBodyFemaleSpellcast) c['lpc_body_female_spellcast'] = lpcBodyFemaleSpellcast;
    if (lpcBodyFemaleThrust) c['lpc_body_female_thrust'] = lpcBodyFemaleThrust;
    if (lpcHairBobBackslash) c['lpc_hair_bob_backslash'] = lpcHairBobBackslash;
    if (lpcHairBobClimb) c['lpc_hair_bob_climb'] = lpcHairBobClimb;
    if (lpcHairBobCombatidle) c['lpc_hair_bob_combat_idle'] = lpcHairBobCombatidle;
    if (lpcHairBobEmote) c['lpc_hair_bob_emote'] = lpcHairBobEmote;
    if (lpcHairBobHalfslash) c['lpc_hair_bob_halfslash'] = lpcHairBobHalfslash;
    if (lpcHairBobJump) c['lpc_hair_bob_jump'] = lpcHairBobJump;
    if (lpcHairBobRun) c['lpc_hair_bob_run'] = lpcHairBobRun;
    if (lpcHairBobShoot) c['lpc_hair_bob_shoot'] = lpcHairBobShoot;
    if (lpcHairBobSit) c['lpc_hair_bob_sit'] = lpcHairBobSit;
    if (lpcHairBobSpellcast) c['lpc_hair_bob_spellcast'] = lpcHairBobSpellcast;
    if (lpcHairBobThrust) c['lpc_hair_bob_thrust'] = lpcHairBobThrust;
    if (lpcHairBraidBackslash) c['lpc_hair_braid_backslash'] = lpcHairBraidBackslash;
    if (lpcHairBraidClimb) c['lpc_hair_braid_climb'] = lpcHairBraidClimb;
    if (lpcHairBraidCombatidle) c['lpc_hair_braid_combat_idle'] = lpcHairBraidCombatidle;
    if (lpcHairBraidEmote) c['lpc_hair_braid_emote'] = lpcHairBraidEmote;
    if (lpcHairBraidHalfslash) c['lpc_hair_braid_halfslash'] = lpcHairBraidHalfslash;
    if (lpcHairBraidJump) c['lpc_hair_braid_jump'] = lpcHairBraidJump;
    if (lpcHairBraidRun) c['lpc_hair_braid_run'] = lpcHairBraidRun;
    if (lpcHairBraidShoot) c['lpc_hair_braid_shoot'] = lpcHairBraidShoot;
    if (lpcHairBraidSit) c['lpc_hair_braid_sit'] = lpcHairBraidSit;
    if (lpcHairBraidSpellcast) c['lpc_hair_braid_spellcast'] = lpcHairBraidSpellcast;
    if (lpcHairBraidThrust) c['lpc_hair_braid_thrust'] = lpcHairBraidThrust;
    if (lpcHairBangsBackslash) c['lpc_hair_bangs_backslash'] = lpcHairBangsBackslash;
    if (lpcHairBangsClimb) c['lpc_hair_bangs_climb'] = lpcHairBangsClimb;
    if (lpcHairBangsCombatidle) c['lpc_hair_bangs_combat_idle'] = lpcHairBangsCombatidle;
    if (lpcHairBangsEmote) c['lpc_hair_bangs_emote'] = lpcHairBangsEmote;
    if (lpcHairBangsHalfslash) c['lpc_hair_bangs_halfslash'] = lpcHairBangsHalfslash;
    if (lpcHairBangsJump) c['lpc_hair_bangs_jump'] = lpcHairBangsJump;
    if (lpcHairBangsRun) c['lpc_hair_bangs_run'] = lpcHairBangsRun;
    if (lpcHairBangsShoot) c['lpc_hair_bangs_shoot'] = lpcHairBangsShoot;
    if (lpcHairBangsSit) c['lpc_hair_bangs_sit'] = lpcHairBangsSit;
    if (lpcHairBangsSpellcast) c['lpc_hair_bangs_spellcast'] = lpcHairBangsSpellcast;
    if (lpcHairBangsThrust) c['lpc_hair_bangs_thrust'] = lpcHairBangsThrust;
    if (lpcHairAfroBackslash) c['lpc_hair_afro_backslash'] = lpcHairAfroBackslash;
    if (lpcHairAfroClimb) c['lpc_hair_afro_climb'] = lpcHairAfroClimb;
    if (lpcHairAfroCombatidle) c['lpc_hair_afro_combat_idle'] = lpcHairAfroCombatidle;
    if (lpcHairAfroEmote) c['lpc_hair_afro_emote'] = lpcHairAfroEmote;
    if (lpcHairAfroHalfslash) c['lpc_hair_afro_halfslash'] = lpcHairAfroHalfslash;
    if (lpcHairAfroJump) c['lpc_hair_afro_jump'] = lpcHairAfroJump;
    if (lpcHairAfroRun) c['lpc_hair_afro_run'] = lpcHairAfroRun;
    if (lpcHairAfroShoot) c['lpc_hair_afro_shoot'] = lpcHairAfroShoot;
    if (lpcHairAfroSit) c['lpc_hair_afro_sit'] = lpcHairAfroSit;
    if (lpcHairAfroSpellcast) c['lpc_hair_afro_spellcast'] = lpcHairAfroSpellcast;
    if (lpcHairAfroThrust) c['lpc_hair_afro_thrust'] = lpcHairAfroThrust;
    if (lpcHairBuzzcutBackslash) c['lpc_hair_buzzcut_backslash'] = lpcHairBuzzcutBackslash;
    if (lpcHairBuzzcutClimb) c['lpc_hair_buzzcut_climb'] = lpcHairBuzzcutClimb;
    if (lpcHairBuzzcutCombatidle) c['lpc_hair_buzzcut_combat_idle'] = lpcHairBuzzcutCombatidle;
    if (lpcHairBuzzcutEmote) c['lpc_hair_buzzcut_emote'] = lpcHairBuzzcutEmote;
    if (lpcHairBuzzcutHalfslash) c['lpc_hair_buzzcut_halfslash'] = lpcHairBuzzcutHalfslash;
    if (lpcHairBuzzcutJump) c['lpc_hair_buzzcut_jump'] = lpcHairBuzzcutJump;
    if (lpcHairBuzzcutRun) c['lpc_hair_buzzcut_run'] = lpcHairBuzzcutRun;
    if (lpcHairBuzzcutShoot) c['lpc_hair_buzzcut_shoot'] = lpcHairBuzzcutShoot;
    if (lpcHairBuzzcutSit) c['lpc_hair_buzzcut_sit'] = lpcHairBuzzcutSit;
    if (lpcHairBuzzcutSpellcast) c['lpc_hair_buzzcut_spellcast'] = lpcHairBuzzcutSpellcast;
    if (lpcHairBuzzcutThrust) c['lpc_hair_buzzcut_thrust'] = lpcHairBuzzcutThrust;
    if (lpcHairCornrowsBackslash) c['lpc_hair_cornrows_backslash'] = lpcHairCornrowsBackslash;
    if (lpcHairCornrowsClimb) c['lpc_hair_cornrows_climb'] = lpcHairCornrowsClimb;
    if (lpcHairCornrowsCombatidle) c['lpc_hair_cornrows_combat_idle'] = lpcHairCornrowsCombatidle;
    if (lpcHairCornrowsEmote) c['lpc_hair_cornrows_emote'] = lpcHairCornrowsEmote;
    if (lpcHairCornrowsHalfslash) c['lpc_hair_cornrows_halfslash'] = lpcHairCornrowsHalfslash;
    if (lpcHairCornrowsJump) c['lpc_hair_cornrows_jump'] = lpcHairCornrowsJump;
    if (lpcHairCornrowsRun) c['lpc_hair_cornrows_run'] = lpcHairCornrowsRun;
    if (lpcHairCornrowsShoot) c['lpc_hair_cornrows_shoot'] = lpcHairCornrowsShoot;
    if (lpcHairCornrowsSit) c['lpc_hair_cornrows_sit'] = lpcHairCornrowsSit;
    if (lpcHairCornrowsSpellcast) c['lpc_hair_cornrows_spellcast'] = lpcHairCornrowsSpellcast;
    if (lpcHairCornrowsThrust) c['lpc_hair_cornrows_thrust'] = lpcHairCornrowsThrust;
    if (lpcHairCurlyBackslash) c['lpc_hair_curly_backslash'] = lpcHairCurlyBackslash;
    if (lpcHairCurlyClimb) c['lpc_hair_curly_climb'] = lpcHairCurlyClimb;
    if (lpcHairCurlyCombatidle) c['lpc_hair_curly_combat_idle'] = lpcHairCurlyCombatidle;
    if (lpcHairCurlyEmote) c['lpc_hair_curly_emote'] = lpcHairCurlyEmote;
    if (lpcHairCurlyHalfslash) c['lpc_hair_curly_halfslash'] = lpcHairCurlyHalfslash;
    if (lpcHairCurlyJump) c['lpc_hair_curly_jump'] = lpcHairCurlyJump;
    if (lpcHairCurlyRun) c['lpc_hair_curly_run'] = lpcHairCurlyRun;
    if (lpcHairCurlyShoot) c['lpc_hair_curly_shoot'] = lpcHairCurlyShoot;
    if (lpcHairCurlySit) c['lpc_hair_curly_sit'] = lpcHairCurlySit;
    if (lpcHairCurlySpellcast) c['lpc_hair_curly_spellcast'] = lpcHairCurlySpellcast;
    if (lpcHairCurlyThrust) c['lpc_hair_curly_thrust'] = lpcHairCurlyThrust;
    if (lpcHairLongBackslash) c['lpc_hair_long_backslash'] = lpcHairLongBackslash;
    if (lpcHairLongClimb) c['lpc_hair_long_climb'] = lpcHairLongClimb;
    if (lpcHairLongCombatidle) c['lpc_hair_long_combat_idle'] = lpcHairLongCombatidle;
    if (lpcHairLongEmote) c['lpc_hair_long_emote'] = lpcHairLongEmote;
    if (lpcHairLongHalfslash) c['lpc_hair_long_halfslash'] = lpcHairLongHalfslash;
    if (lpcHairLongJump) c['lpc_hair_long_jump'] = lpcHairLongJump;
    if (lpcHairLongRun) c['lpc_hair_long_run'] = lpcHairLongRun;
    if (lpcHairLongShoot) c['lpc_hair_long_shoot'] = lpcHairLongShoot;
    if (lpcHairLongSit) c['lpc_hair_long_sit'] = lpcHairLongSit;
    if (lpcHairLongSpellcast) c['lpc_hair_long_spellcast'] = lpcHairLongSpellcast;
    if (lpcHairLongThrust) c['lpc_hair_long_thrust'] = lpcHairLongThrust;
    if (lpcTorsoTshirtBackslash) c['lpc_torso_tshirt_backslash'] = lpcTorsoTshirtBackslash;
    if (lpcTorsoTshirtClimb) c['lpc_torso_tshirt_climb'] = lpcTorsoTshirtClimb;
    if (lpcTorsoTshirtCombatidle) c['lpc_torso_tshirt_combat_idle'] = lpcTorsoTshirtCombatidle;
    if (lpcTorsoTshirtEmote) c['lpc_torso_tshirt_emote'] = lpcTorsoTshirtEmote;
    if (lpcTorsoTshirtHalfslash) c['lpc_torso_tshirt_halfslash'] = lpcTorsoTshirtHalfslash;
    if (lpcTorsoTshirtJump) c['lpc_torso_tshirt_jump'] = lpcTorsoTshirtJump;
    if (lpcTorsoTshirtRun) c['lpc_torso_tshirt_run'] = lpcTorsoTshirtRun;
    if (lpcTorsoTshirtShoot) c['lpc_torso_tshirt_shoot'] = lpcTorsoTshirtShoot;
    if (lpcTorsoTshirtSit) c['lpc_torso_tshirt_sit'] = lpcTorsoTshirtSit;
    if (lpcTorsoTshirtSpellcast) c['lpc_torso_tshirt_spellcast'] = lpcTorsoTshirtSpellcast;
    if (lpcTorsoTshirtThrust) c['lpc_torso_tshirt_thrust'] = lpcTorsoTshirtThrust;
    if (lpcTorsoLeatherClimb) c['lpc_torso_leather_climb'] = lpcTorsoLeatherClimb;
    if (lpcTorsoLeatherEmote) c['lpc_torso_leather_emote'] = lpcTorsoLeatherEmote;
    if (lpcTorsoLeatherJump) c['lpc_torso_leather_jump'] = lpcTorsoLeatherJump;
    if (lpcTorsoLeatherShoot) c['lpc_torso_leather_shoot'] = lpcTorsoLeatherShoot;
    if (lpcTorsoLeatherSit) c['lpc_torso_leather_sit'] = lpcTorsoLeatherSit;
    if (lpcTorsoLeatherSpellcast) c['lpc_torso_leather_spellcast'] = lpcTorsoLeatherSpellcast;
    if (lpcTorsoLeatherThrust) c['lpc_torso_leather_thrust'] = lpcTorsoLeatherThrust;
    if (lpcTorsoPlateBackslash) c['lpc_torso_plate_backslash'] = lpcTorsoPlateBackslash;
    if (lpcTorsoPlateClimb) c['lpc_torso_plate_climb'] = lpcTorsoPlateClimb;
    if (lpcTorsoPlateCombatidle) c['lpc_torso_plate_combat_idle'] = lpcTorsoPlateCombatidle;
    if (lpcTorsoPlateEmote) c['lpc_torso_plate_emote'] = lpcTorsoPlateEmote;
    if (lpcTorsoPlateHalfslash) c['lpc_torso_plate_halfslash'] = lpcTorsoPlateHalfslash;
    if (lpcTorsoPlateJump) c['lpc_torso_plate_jump'] = lpcTorsoPlateJump;
    if (lpcTorsoPlateRun) c['lpc_torso_plate_run'] = lpcTorsoPlateRun;
    if (lpcTorsoPlateShoot) c['lpc_torso_plate_shoot'] = lpcTorsoPlateShoot;
    if (lpcTorsoPlateSit) c['lpc_torso_plate_sit'] = lpcTorsoPlateSit;
    if (lpcTorsoPlateSpellcast) c['lpc_torso_plate_spellcast'] = lpcTorsoPlateSpellcast;
    if (lpcTorsoPlateThrust) c['lpc_torso_plate_thrust'] = lpcTorsoPlateThrust;
    if (lpcLegsPantsBackslash) c['lpc_legs_pants_backslash'] = lpcLegsPantsBackslash;
    if (lpcLegsPantsClimb) c['lpc_legs_pants_climb'] = lpcLegsPantsClimb;
    if (lpcLegsPantsCombatidle) c['lpc_legs_pants_combat_idle'] = lpcLegsPantsCombatidle;
    if (lpcLegsPantsEmote) c['lpc_legs_pants_emote'] = lpcLegsPantsEmote;
    if (lpcLegsPantsHalfslash) c['lpc_legs_pants_halfslash'] = lpcLegsPantsHalfslash;
    if (lpcLegsPantsJump) c['lpc_legs_pants_jump'] = lpcLegsPantsJump;
    if (lpcLegsPantsRun) c['lpc_legs_pants_run'] = lpcLegsPantsRun;
    if (lpcLegsPantsShoot) c['lpc_legs_pants_shoot'] = lpcLegsPantsShoot;
    if (lpcLegsPantsSit) c['lpc_legs_pants_sit'] = lpcLegsPantsSit;
    if (lpcLegsPantsSpellcast) c['lpc_legs_pants_spellcast'] = lpcLegsPantsSpellcast;
    if (lpcLegsPantsThrust) c['lpc_legs_pants_thrust'] = lpcLegsPantsThrust;
    if (lpcLegsShortsBackslash) c['lpc_legs_shorts_backslash'] = lpcLegsShortsBackslash;
    if (lpcLegsShortsClimb) c['lpc_legs_shorts_climb'] = lpcLegsShortsClimb;
    if (lpcLegsShortsCombatidle) c['lpc_legs_shorts_combat_idle'] = lpcLegsShortsCombatidle;
    if (lpcLegsShortsEmote) c['lpc_legs_shorts_emote'] = lpcLegsShortsEmote;
    if (lpcLegsShortsHalfslash) c['lpc_legs_shorts_halfslash'] = lpcLegsShortsHalfslash;
    if (lpcLegsShortsJump) c['lpc_legs_shorts_jump'] = lpcLegsShortsJump;
    if (lpcLegsShortsRun) c['lpc_legs_shorts_run'] = lpcLegsShortsRun;
    if (lpcLegsShortsShoot) c['lpc_legs_shorts_shoot'] = lpcLegsShortsShoot;
    if (lpcLegsShortsSit) c['lpc_legs_shorts_sit'] = lpcLegsShortsSit;
    if (lpcLegsShortsSpellcast) c['lpc_legs_shorts_spellcast'] = lpcLegsShortsSpellcast;
    if (lpcLegsShortsThrust) c['lpc_legs_shorts_thrust'] = lpcLegsShortsThrust;
    if (lpcFeetBootsBackslash) c['lpc_feet_boots_backslash'] = lpcFeetBootsBackslash;
    if (lpcFeetBootsClimb) c['lpc_feet_boots_climb'] = lpcFeetBootsClimb;
    if (lpcFeetBootsCombatidle) c['lpc_feet_boots_combat_idle'] = lpcFeetBootsCombatidle;
    if (lpcFeetBootsEmote) c['lpc_feet_boots_emote'] = lpcFeetBootsEmote;
    if (lpcFeetBootsHalfslash) c['lpc_feet_boots_halfslash'] = lpcFeetBootsHalfslash;
    if (lpcFeetBootsJump) c['lpc_feet_boots_jump'] = lpcFeetBootsJump;
    if (lpcFeetBootsRun) c['lpc_feet_boots_run'] = lpcFeetBootsRun;
    if (lpcFeetBootsShoot) c['lpc_feet_boots_shoot'] = lpcFeetBootsShoot;
    if (lpcFeetBootsSit) c['lpc_feet_boots_sit'] = lpcFeetBootsSit;
    if (lpcFeetBootsSpellcast) c['lpc_feet_boots_spellcast'] = lpcFeetBootsSpellcast;
    if (lpcFeetBootsThrust) c['lpc_feet_boots_thrust'] = lpcFeetBootsThrust;
  }, [
    ...
    lpcBodyMaleBackslash,lpcBodyMaleClimb,lpcBodyMaleCombatidle,lpcBodyMaleEmote,lpcBodyMaleHalfslash,lpcBodyMaleJump,lpcBodyMaleRun,lpcBodyMaleShoot,lpcBodyMaleSit,lpcBodyMaleSpellcast,lpcBodyMaleThrust,lpcBodyFemaleBackslash,lpcBodyFemaleClimb,lpcBodyFemaleCombatidle,lpcBodyFemaleEmote,lpcBodyFemaleHalfslash,lpcBodyFemaleJump,lpcBodyFemaleRun,lpcBodyFemaleShoot,lpcBodyFemaleSit,lpcBodyFemaleSpellcast,lpcBodyFemaleThrust,lpcHairBobBackslash,lpcHairBobClimb,lpcHairBobCombatidle,lpcHairBobEmote,lpcHairBobHalfslash,lpcHairBobJump,lpcHairBobRun,lpcHairBobShoot,lpcHairBobSit,lpcHairBobSpellcast,lpcHairBobThrust,lpcHairBraidBackslash,lpcHairBraidClimb,lpcHairBraidCombatidle,lpcHairBraidEmote,lpcHairBraidHalfslash,lpcHairBraidJump,lpcHairBraidRun,lpcHairBraidShoot,lpcHairBraidSit,lpcHairBraidSpellcast,lpcHairBraidThrust,lpcHairBangsBackslash,lpcHairBangsClimb,lpcHairBangsCombatidle,lpcHairBangsEmote,lpcHairBangsHalfslash,lpcHairBangsJump,lpcHairBangsRun,lpcHairBangsShoot,lpcHairBangsSit,lpcHairBangsSpellcast,lpcHairBangsThrust,lpcHairAfroBackslash,lpcHairAfroClimb,lpcHairAfroCombatidle,lpcHairAfroEmote,lpcHairAfroHalfslash,lpcHairAfroJump,lpcHairAfroRun,lpcHairAfroShoot,lpcHairAfroSit,lpcHairAfroSpellcast,lpcHairAfroThrust,lpcHairBuzzcutBackslash,lpcHairBuzzcutClimb,lpcHairBuzzcutCombatidle,lpcHairBuzzcutEmote,lpcHairBuzzcutHalfslash,lpcHairBuzzcutJump,lpcHairBuzzcutRun,lpcHairBuzzcutShoot,lpcHairBuzzcutSit,lpcHairBuzzcutSpellcast,lpcHairBuzzcutThrust,lpcHairCornrowsBackslash,lpcHairCornrowsClimb,lpcHairCornrowsCombatidle,lpcHairCornrowsEmote,lpcHairCornrowsHalfslash,lpcHairCornrowsJump,lpcHairCornrowsRun,lpcHairCornrowsShoot,lpcHairCornrowsSit,lpcHairCornrowsSpellcast,lpcHairCornrowsThrust,lpcHairCurlyBackslash,lpcHairCurlyClimb,lpcHairCurlyCombatidle,lpcHairCurlyEmote,lpcHairCurlyHalfslash,lpcHairCurlyJump,lpcHairCurlyRun,lpcHairCurlyShoot,lpcHairCurlySit,lpcHairCurlySpellcast,lpcHairCurlyThrust,lpcHairLongBackslash,lpcHairLongClimb,lpcHairLongCombatidle,lpcHairLongEmote,lpcHairLongHalfslash,lpcHairLongJump,lpcHairLongRun,lpcHairLongShoot,lpcHairLongSit,lpcHairLongSpellcast,lpcHairLongThrust,lpcTorsoTshirtBackslash,lpcTorsoTshirtClimb,lpcTorsoTshirtCombatidle,lpcTorsoTshirtEmote,lpcTorsoTshirtHalfslash,lpcTorsoTshirtJump,lpcTorsoTshirtRun,lpcTorsoTshirtShoot,lpcTorsoTshirtSit,lpcTorsoTshirtSpellcast,lpcTorsoTshirtThrust,lpcTorsoLeatherClimb,lpcTorsoLeatherEmote,lpcTorsoLeatherJump,lpcTorsoLeatherShoot,lpcTorsoLeatherSit,lpcTorsoLeatherSpellcast,lpcTorsoLeatherThrust,lpcTorsoPlateBackslash,lpcTorsoPlateClimb,lpcTorsoPlateCombatidle,lpcTorsoPlateEmote,lpcTorsoPlateHalfslash,lpcTorsoPlateJump,lpcTorsoPlateRun,lpcTorsoPlateShoot,lpcTorsoPlateSit,lpcTorsoPlateSpellcast,lpcTorsoPlateThrust,lpcLegsPantsBackslash,lpcLegsPantsClimb,lpcLegsPantsCombatidle,lpcLegsPantsEmote,lpcLegsPantsHalfslash,lpcLegsPantsJump,lpcLegsPantsRun,lpcLegsPantsShoot,lpcLegsPantsSit,lpcLegsPantsSpellcast,lpcLegsPantsThrust,lpcLegsShortsBackslash,lpcLegsShortsClimb,lpcLegsShortsCombatidle,lpcLegsShortsEmote,lpcLegsShortsHalfslash,lpcLegsShortsJump,lpcLegsShortsRun,lpcLegsShortsShoot,lpcLegsShortsSit,lpcLegsShortsSpellcast,lpcLegsShortsThrust,lpcFeetBootsBackslash,lpcFeetBootsClimb,lpcFeetBootsCombatidle,lpcFeetBootsEmote,lpcFeetBootsHalfslash,lpcFeetBootsJump,lpcFeetBootsRun,lpcFeetBootsShoot,lpcFeetBootsSit,lpcFeetBootsSpellcast,lpcFeetBootsThrust,,
  ]);
